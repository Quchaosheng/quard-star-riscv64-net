...
- OpenSBI PMP isolates hart7's 8 MiB trusted RAM and UART2 from harts 0-6, and isolates ordinary RAM from hart7. The bidirectional fault probes are QEMU-only; there is no physical-board, DMA-isolation, or side-channel claim.
