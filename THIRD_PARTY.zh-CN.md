...
第三方源码保留其上游许可证。Git 依赖由仓库 gitlink 固定版本；FatFs 由官方
压缩包的校验和固定版本。
...
| FatFs | [Elm-Chan FatFs](https://elm-chan.org/fsw/ff/) | `R0.15` | SHA-256 `e0d76654d877e6c74be5ea3c395808794d495169514e98cbf6046168b8f4f070` | FatFs license | VirtIO block 上的 FAT 文件系统 | 压缩包保持不变；磁盘移植层是第一方代码 |
